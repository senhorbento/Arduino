...
void setup(){
    ...
    cosseno:                                     //inicio cosseno
    l="";i="";k=7;a=0;h=0;
    while(h==0){
        lcd.setCursor(3,0);
        lcd.print("Trig-Cosseno");
        lcd.setCursor(0,1);
        lcd.print("Angulo:");
        l=teclado.getKey();
        if(l!=NO_KEY){
    ...
    tangente:                                   //inicio tangente
    l="";i="";k=7;a=0;h=0;
    while(h==0){
        lcd.setCursor(3,0);
        lcd.print("Trig-Tangente");
        lcd.setCursor(0,1);
        lcd.print("Angulo:");
        l=teclado.getKey();
        if(l!=NO_KEY){
    ...
    while(l!="#"){                   
        if ((millis()-timer)>1000){
            umi=(sonar.ping_median(10));
            umi=(sonar.convert_cm(umi));
            timer=millis();
            lcd.setCursor(8,0);
            lcd.print("Sensor");
            lcd.setCursor(0,1);
